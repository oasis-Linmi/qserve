...
max_batch_size_base = [190, 151, 146, 146, 102, 77, 73]
# batch_sizes[0] = 1
# 设置CUDA设备为7号GPU
...
for model_index, model_path in enumerate(model_paths):
    ...
    output_filename = "./max_bs_results/" + model_path.replace("/", "_").lstrip("_") + "test_on_max_bs.txt"
    test_batch_size_base = max_batch_size_base[model_index]
    test_batch_sizes = [test_batch_size_base]
